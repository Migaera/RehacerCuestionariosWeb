...
for(var i = 0; i < preguntasClientelength; i++){
...
respuestasCliente[3][13]="Se realiza en el cliente";
...
respuestasCliente[4][27]="Ninguna de las anteriores es correcta";
...
respuestasCliente[7][1]="Respuesta";
respuestasCliente[7][2]="Respuesta";
respuestasCliente[7][3]="Respuesta";
respuestasCliente[7][4]="RespuestaCorrecta";
respuestasCliente[7][5]="Respuesta";
respuestasCliente[7][6]="Respuesta";
respuestasCliente[7][7]="Respuesta";
respuestasCliente[7][8]="RespuestaCorrecta";
respuestasCliente[7][9]="Respuesta";
respuestasCliente[7][10]="Respuesta";
respuestasCliente[7][11]="Respuesta";
respuestasCliente[7][12]="RespuestaCorrecta";
respuestasCliente[7][13]="Respuesta";
respuestasCliente[7][14]="Respuesta";
respuestasCliente[7][15]="Respuesta";
respuestasCliente[7][16]="RespuestaCorrecta";
respuestasCliente[7][17]="Respuesta";
respuestasCliente[7][18]="Respuesta";
respuestasCliente[7][19]="Respuesta";
respuestasCliente[7][20]="RespuestaCorrecta";
respuestasCliente[7][21]="Respuesta";
respuestasCliente[7][22]="Respuesta";
respuestasCliente[7][23]="Respuesta";
respuestasCliente[7][24]="RespuestaCorrecta";
respuestasCliente[7][25]="Respuesta";
respuestasCliente[7][26]="Respuesta";
respuestasCliente[7][27]="Respuesta";
respuestasCliente[7][28]="RespuestaCorrecta";
respuestasCliente[7][29]="Respuesta";
respuestasCliente[7][30]="Respuesta";
respuestasCliente[7][31]="Respuesta";
respuestasCliente[7][32]="RespuestaCorrecta";
respuestasCliente[7][33]="Respuesta";
respuestasCliente[7][34]="Respuesta";
respuestasCliente[7][35]="Respuesta";
respuestasCliente[7][36]="RespuestaCorrecta";
respuestasCliente[7][37]="Respuesta";
respuestasCliente[7][38]="Respuesta";
respuestasCliente[7][39]="Respuesta";

preguntasCliente[7][0]="Pregunta";
preguntasCliente[7][1]="Pregunta";
preguntasCliente[7][2]="Pregunta";
preguntasCliente[7][3]="Pregunta";
preguntasCliente[7][4]="Pregunta";
preguntasCliente[7][5]="Pregunta";
preguntasCliente[7][6]="Pregunta";
preguntasCliente[7][7]="Pregunta";
...
addEventListener("load",function Start(){
    for(var i = 0; i < 30; i++){
        ...
        arrTemas.push(tema)
        document.getElementsByClassName("titlePregunta")[i].innerHTML = i+1 + ". " + preguntasCliente[tema][newI];
        
        
        
        for(var j = 1; j < 5; j++){
            document.getElementsByTagName("label")[newJ].firstElementChild.innerHTML = respuestasCliente[tema][(newI*4)+j-1];
            newJ++;
...
function Finalizar(){
    ...
    for(var i = 0; i < 30;i++){
        ...
        if(intrespuestasCliente[i] == intCorrectas[i] && intrespuestasCliente[i] != null){
            nota+= 0.333;
            console.log("acierto")
            
        }else if(intrespuestasCliente[i] != intCorrectas[i] && intrespuestasCliente[i] != null) {
            nota -= 0.111
            console.log("fallo")
        }else{
            console.log("saltada")
...
/*
//Tema x
respuestasCliente[x][0]="Respuesta";
respuestasCliente[x][1]="Respuesta";
respuestasCliente[x][2]="Respuesta";
respuestasCliente[x][3]="Respuesta";
respuestasCliente[x][4]="Respuesta";
respuestasCliente[x][5]="Respuesta";
respuestasCliente[x][6]="Respuesta";
respuestasCliente[x][7]="Respuesta";
respuestasCliente[x][8]="Respuesta";
respuestasCliente[x][9]="Respuesta";
respuestasCliente[x][10]="Respuesta";
respuestasCliente[x][11]="Respuesta";
respuestasCliente[x][12]="Respuesta";
respuestasCliente[x][13]="Respuesta";
respuestasCliente[x][14]="Respuesta";
respuestasCliente[x][15]="Respuesta";
respuestasCliente[x][16]="Respuesta";
respuestasCliente[x][17]="Respuesta";
respuestasCliente[x][18]="Respuesta";
respuestasCliente[x][19]="Respuesta";
respuestasCliente[x][20]="Respuesta";
respuestasCliente[x][21]="Respuesta";
respuestasCliente[x][22]="Respuesta";
respuestasCliente[x][23]="Respuesta";
respuestasCliente[x][24]="Respuesta";
respuestasCliente[x][25]="Respuesta";
respuestasCliente[x][26]="Respuesta";
respuestasCliente[x][27]="Respuesta";
respuestasCliente[x][28]="Respuesta";
respuestasCliente[x][29]="Respuesta";
respuestasCliente[x][30]="Respuesta";
respuestasCliente[x][31]="Respuesta";
respuestasCliente[x][32]="Respuesta";
respuestasCliente[x][33]="Respuesta";
respuestasCliente[x][34]="Respuesta";
respuestasCliente[x][35]="Respuesta";
respuestasCliente[x][36]="Respuesta";
respuestasCliente[x][37]="Respuesta";
respuestasCliente[x][38]="Respuesta";
respuestasCliente[x][39]="Respuesta";

preguntasCliente[x][0]="Pregunta";
preguntasCliente[x][1]="Pregunta";
preguntasCliente[x][2]="Pregunta";
preguntasCliente[x][3]="Pregunta";
preguntasCliente[x][4]="Pregunta";
preguntasCliente[x][5]="Pregunta";
preguntasCliente[x][6]="Pregunta";
preguntasCliente[x][7]="Pregunta";
