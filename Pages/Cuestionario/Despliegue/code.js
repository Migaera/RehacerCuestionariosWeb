...
//Tema 6
respuestas[6][0]="núcleo";
respuestas[6][1]="middleware";
respuestas[6][2]="kernel";
respuestas[6][3]="Ninguna de las anteriores es correcta";
respuestas[6][4]="Aplicaciones web escritas en Java que son compiladas para ser ejecutadas por un servidor de aplicaciones web";
respuestas[6][5]="Módulos php";
respuestas[6][6]="Servidores web";
respuestas[6][7]="Servicios que nos permiten desplegar aplicaciones webs";
respuestas[6][8]="Un servidor web";
respuestas[6][9]="Un servidor de aplicaciones";
respuestas[6][10]="Un servidor de transferencia de archivos";
respuestas[6][11]="Ninguna de las anteriores";
respuestas[6][12]="PHP-7.0";
respuestas[6][13]="Python";
respuestas[6][14]="Java Runtine Environment";
respuestas[6][15]="Ninguna de las anteriores";
respuestas[6][16]=".war ";
respuestas[6][17]=".jar";
respuestas[6][18]=".zar ";
respuestas[6][19]="Ninguna de las anteriores";
respuestas[6][20]="IDE";
respuestas[6][21]="EDI";
respuestas[6][22]="CAD";
respuestas[6][23]="Ninguna de las anteriores";
respuestas[6][24]="web.java";
respuestas[6][25]="Web.xml";
respuestas[6][26]="Web.conf";
respuestas[6][27]="Un protocolo de seguridad de las páginas web";
respuestas[6][28]="Un servidor de aplicaciones javacript";
respuestas[6][29]="Un servidor web";
respuestas[6][30]="Un servidor DNS";
respuestas[6][31]="Ninguna de las anteriores";
respuestas[6][32]="Motor V8 de Oracle";
respuestas[6][33]="Motor es5";
respuestas[6][34]="Motor V8 de Google";
respuestas[6][35]="Ninguna de las anteriores";
respuestas[6][36]="Escalabilidad";
respuestas[6][37]="independencia de software";
respuestas[6][38]="facilidad de mantenimiento";
respuestas[6][39]="Todas las anteriores son correctas";

preguntas[6][0]="El software intermedio que permite la ejecución de código y se comunica con la base de datos se llama:";
preguntas[6][1]="Los servlest son...";
preguntas[6][2]="Apache Tomcat es…";
preguntas[6][3]="Qué será necesario para poder ejecutar Tomcat…";
preguntas[6][4]="Los archivos, contenido multimedia y librerías de una aplicación web se empaquetarán en un archivo con extensión…";
preguntas[6][5]="Los programas que nos aportan un entorno de desarrollo integrado se llaman…";
preguntas[6][6]="¿Qué nombre tendrá el descriptor de despliegue de una aplicación web?";
preguntas[6][7]="Node.js es…";
preguntas[6][8]="¿Qué motor de JavaScript utiliza node.js?";
preguntas[6][9]="¿Qué ventajas aporta Docker en el despliegue de aplicaciones?";

respuestasCorrectas[6][0]="middleware";
respuestasCorrectas[6][1]="Aplicaciones web escritas en Java que son compiladas para ser ejecutadas por un servidor de aplicaciones web";
respuestasCorrectas[6][2]="Un servidor de aplicaciones";
respuestasCorrectas[6][3]="Java Runtine Environment";
respuestasCorrectas[6][4]=".war ";
respuestasCorrectas[6][5]="IDE";
respuestasCorrectas[6][6]="Web.xml";
respuestasCorrectas[6][7]="Un servidor de aplicaciones javacript";
respuestasCorrectas[6][8]="Motor V8 de Google";
respuestasCorrectas[6][9]="Todas las anteriores son correctas";
